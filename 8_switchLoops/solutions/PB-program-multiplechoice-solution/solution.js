...
// Generally, if we are testing an expression or boolean values, then we would use if/else. 
// In contrast, we would use switch when choosing between a number of options.
